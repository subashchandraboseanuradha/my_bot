...
foreach(_expectedTarget my_bot::my_bot)
...
# Create imported target my_bot::my_bot
add_library(my_bot::my_bot SHARED IMPORTED)
...
file(GLOB CONFIG_FILES "${_DIR}/export_my_botExport-*.cmake")
